...
try:
    from sync.mcp_client import create_direct_mcp_client
except ImportError:
...
def sync_telegram_to_asana(
    ...
    # Сопоставление задач через временные окна и кеш эмбеддингов
    print("\n🔍 Сопоставление задач (временные окна + кеш эмбеддингов)...")
