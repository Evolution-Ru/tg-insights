...
from shared.utils.db import get_db_connection, get_all_messages_from_chats
from shared.utils.formatting import format_messages_as_thread
from pipeline.telegram.summarization.compress import compress_thread_with_smart_model
from pipeline.telegram.vectorization.embeddings import save_embeddings_for_level
...
project_root = script_dir.parent.parent  # ai-pmtool/ (scripts/telegram/ -> scripts/ -> ai-pmtool/)
